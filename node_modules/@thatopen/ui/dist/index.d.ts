...
export declare class Chart extends LitElement {
    ...
    get data(): ChartData<Types, (number | [number, number] | Point | BubbleDataPoint | null)[], unknown>;
...
export declare class TableCell<T extends TableRowData> extends LitElement {
    ...
    get headersTransform(): TableHeadersTransform<T>[keyof T] | undefined;
    private _renderValue;
    get templateValue(): unknown;
    connectedCallback(): void;
    protected render(): TemplateResult_2<1>;
}
...
/**
 * Represents a transformation function for table headers.
 */
export declare type TableHeadersTransform<T extends TableRowData = TableRowData> = {
    [K in keyof T]?: (columnName: K) => CellRenderValue;
};
...
export declare class TableRow<T extends TableRowData> extends LitElement {
    ...
    private _headerCheckboxUpdatePending;
